...
class DD_Progress_Slider_Widget extends \Elementor\Widget_Base {
	 ...
	 * Includes grouped tabs for Content, Background, Background Overlay, and Global Styles.
	 *
	 * @return void
	 */
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .dd-slide-heading' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dd-slide-heading',
			]
		);
		...
		$this->add_responsive_control(
			'heading_spacing',
			[
				'label'      => esc_html__( 'Bottom Spacing', 'dd-addons' ),
				'type'       => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .dd-slide-heading' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dd-slide-description' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .dd-slide-description',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .dd-slide-description' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'dd-addons' ),
				'selector' => '{{WRAPPER}} .dd-btn',
			]
		);
		...
		$this->add_responsive_control(
			'buttons_padding',
			[
				'label'      => esc_html__( 'Padding', 'dd-addons' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dd-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label'      => esc_html__( 'Border Radius', 'dd-addons' ),
				'type'       => \Elementor\Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .dd-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid' => 'color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			'solid_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid' => 'background-color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			'solid_border_color',
			[
				'label'     => esc_html__( 'Border Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid' => 'border-color: {{VALUE}};' ],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid:hover' => 'color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			'solid_hover_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid:hover' => 'background-color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			'solid_hover_border_color',
			[
				'label'     => esc_html__( 'Border Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-solid:hover' => 'border-color: {{VALUE}};' ],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-outline' => 'color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			'outline_bg_color',
			[
				'label'     => esc_html__( 'Background Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-outline' => 'background-color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-outline' => 'border-color: {{VALUE}};' ],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Text Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-outline:hover' => 'color: {{VALUE}};' ],
			]
		);
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Background Color', 'dd-addons' ),
				'type'      => \Elementor\Controls_Manager::COLOR,
				'selectors' => [ '{{WRAPPER}} .dd-btn-outline:hover' => 'background-color: {{VALUE}};' ],
			]
		);
		$this->add_control(
